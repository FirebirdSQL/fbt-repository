...
create table test(id smallint generated by default as identity primary key using index test_pk_asc, att smallint default current_connection, x smallint);
create table tsrc(id smallint generated by default as identity primary key using index tsrc_pk_asc, att smallint default current_connection, x smallint);
create table flag(id smallint primary key);
commit;
